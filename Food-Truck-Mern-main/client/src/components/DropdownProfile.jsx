    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium text-gray-600 dark:text-gray-600 group-hover:text-gray-800 dark:group-hover:text-slate-600">Acme Inc.</span>
          <svg className="w-3 h-3 shrink-0 ml-1 fill-current text-gray-600 dark:text-gray-500" viewBox="0 0 12 12">
